...
//Класс работающий с файлом конфигураций
...
class Customize{
        ...
        try (FileReader fr = new FileReader(F)){
            ...
            int number_i = 0;
                 ...
                 if (number_i == 1 && line.length() > 10){
                   ...
                   if (check_int == 0){ 
                     GetDir = line.substring(11, line.length()).trim();
                     } else {
                     DeleteCfg();
                     break;
                     }
	...
	return Dir.substring(0, Dir.lastIndexOf("IRENS")+6);
 }
...
class scrollDir {
    ...
    public void treatment_F(File F){
      ...
      if (file_extension.substring(file_extension.lastIndexOf("."), file_extension.length()).equalsIgnoreCase(".txt")  == true){
    ...
    try (FileWriter fw = new FileWriter(F, true)){
        ...
        String[] lines = sb.toString().split(System.getProperty( "line.separator" ));
            for(String line: lines){
                 ...
                 if (line.length() <= 11){
                     line= "+" + line;
                     if (!line.substring(1, 2).equals("7")){
